...
DEFAULT_MODEL_PATH = r"D:\DACN\baocao\main_cnn_attention\models\model_Phase1_Binary_Initial.h5"
...
def plot_recovery_chart(acc_before, acc_after, start_round=5):
    ...
    ax.plot(rounds, baseline_acc, '--', color='gray', label='Baseline: CNN_Attention', alpha=0.5)

...
DEFAULT_MODEL_PATH = r"D:\DACN\baocao\main_cnn_attention_ative_learning\models\CNN_attention_Final.h5"
...
def plot_recovery_chart(acc_before, acc_after, start_round=5):
    ...
    ax.plot(rounds, baseline_acc, '--', color='gray', label='Baseline: CNN_Attention + Ative Learning', alpha=0.5)

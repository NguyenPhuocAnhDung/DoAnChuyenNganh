...
DEFAULT_MODEL_PATH = r"D:\DACN\baocao\main_ative_learning\models\final_model_A.h5"
...
def plot_recovery_chart(acc_before, acc_after, start_round=5):
    ...
    ax.plot(rounds, baseline_acc, '--', color='gray', label='Baseline: CNN-BiGRU', alpha=0.5)
